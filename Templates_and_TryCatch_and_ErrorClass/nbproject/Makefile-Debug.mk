...
${OBJECTDIR}/template/template03.o: template/template03.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/template/template03.o template/template03.cpp

${OBJECTDIR}/template/template04.o: template/template04.cpp 
	${MKDIR} -p ${OBJECTDIR}/template
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/template/template04.o template/template04.cpp
