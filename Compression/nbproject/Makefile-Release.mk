...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/compression.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/compression.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/compression ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/FileFormat.o: FileFormat.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileFormat.o FileFormat.c

${OBJECTDIR}/bitchain/main.o: bitchain/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/bitchain
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bitchain/main.o bitchain/main.cpp
...
${OBJECTDIR}/faili/Patvaliga\ \(binarie\ faili\)/CREATE.o: faili/Patvaliga\ \(binarie\ faili\)/CREATE.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/faili/Patvaliga\ \(binarie\ faili\)/CREATE.o faili/Patvaliga\ \(binarie\ faili\)/CREATE.cpp
...
${OBJECTDIR}/faili/Patvaliga\ \(binarie\ faili\)/FILL.o: faili/Patvaliga\ \(binarie\ faili\)/FILL.cpp 
	${MKDIR} -p ${OBJECTDIR}/faili  faili\)
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/faili/Patvaliga\ \(binarie\ faili\)/FILL.o faili/Patvaliga\ \(binarie\ faili\)/FILL.cpp
...
${OBJECTDIR}/faili/Patvaliga\ \(binarie\ faili\)/READ.o: faili/Patvaliga\ \(binarie\ faili\)/READ.cpp 
	${MKDIR} -p ${OBJECTDIR}/faili  faili\)
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/faili/Patvaliga\ \(binarie\ faili\)/READ.o faili/Patvaliga\ \(binarie\ faili\)/READ.cpp
...
${OBJECTDIR}/main_2.o: main_2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_2.o main_2.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/compression.exe
