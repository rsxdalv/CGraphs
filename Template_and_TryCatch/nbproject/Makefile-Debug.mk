...
${OBJECTDIR}/template/template01.o: template/template01.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/template/template01.o template/template01.cpp

${OBJECTDIR}/template/template02.o: template/template02.cpp 
	${MKDIR} -p ${OBJECTDIR}/template
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/template/template02.o template/template02.cpp
