...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/time_2.exe
...
${OBJECTDIR}/Kompozicija/Date.o: Kompozicija/Date.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Kompozicija/Date.o Kompozicija/Date.cpp

${OBJECTDIR}/Kompozicija/Employee.o: Kompozicija/Employee.cpp 
	${MKDIR} -p ${OBJECTDIR}/Kompozicija
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Kompozicija/Employee.o Kompozicija/Employee.cpp

${OBJECTDIR}/Kompozicija/main.o: Kompozicija/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/Kompozicija
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Kompozicija/main.o Kompozicija/main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/time_2.exe
