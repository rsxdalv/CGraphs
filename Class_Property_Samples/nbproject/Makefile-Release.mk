...
${OBJECTDIR}/1.\ Static/Static.o: 1.\ Static/Static.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1.\ Static/Static.o 1.\ Static/Static.cpp

.NO_PARALLEL:${OBJECTDIR}/2.\ Friends/Friends.o
${OBJECTDIR}/2.\ Friends/Friends.o: 2.\ Friends/Friends.cpp 
	${MKDIR} -p ${OBJECTDIR} Friends
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/2.\ Friends/Friends.o 2.\ Friends/Friends.cpp

.NO_PARALLEL:${OBJECTDIR}/3.\ This/This.o
${OBJECTDIR}/3.\ This/This.o: 3.\ This/This.cpp 
	${MKDIR} -p ${OBJECTDIR} This
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3.\ This/This.o 3.\ This/This.cpp
...
${OBJECTDIR}/4.\ Operatoru\ pardefinesana/OperPard.o: 4.\ Operatoru\ pardefinesana/OperPard.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/4.\ Operatoru\ pardefinesana/OperPard.o 4.\ Operatoru\ pardefinesana/OperPard.cpp
