...
${OBJECTDIR}/EmptyWindowsProject/main.o: EmptyWindowsProject/main.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmptyWindowsProject/main.o EmptyWindowsProject/main.cpp

${OBJECTDIR}/Grafika1/main.o: Grafika1/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/Grafika1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grafika1/main.o Grafika1/main.cpp

${OBJECTDIR}/Grafika1b/main.o: Grafika1b/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/Grafika1b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grafika1b/main.o Grafika1b/main.cpp
