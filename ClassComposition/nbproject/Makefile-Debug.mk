...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/classcomposition.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/classcomposition.exe: ${OBJECTFILES}
...
${OBJECTDIR}/CompositionTest.o: CompositionTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CompositionTest.o CompositionTest.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/classcomposition.exe
