...
${OBJECTDIR}/compr/FileFormat.o: compr/FileFormat.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/compr/FileFormat.o compr/FileFormat.c

${OBJECTDIR}/compr/main.o: compr/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/compr
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/compr/main.o compr/main.cpp

${OBJECTDIR}/em/main.o: em/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/em
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/em/main.o em/main.cpp
